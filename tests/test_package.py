...
class PackageTests(unittest.TestCase):
    ...
    def test_director_runtime_is_packaged_and_selected(self):
        ...
        learning=(ROOT/'solo_engine/plugins/director_learning.py').read_text()
        self.assertIn('class solo_directed(solo_arcade)',directed)
        self.assertIn('class SoloDirector:',director)
        self.assertIn('class DirectorRuntime:',runtime)
        self.assertIn('class DirectorLearning:',learning)
        self.assertIn('director_actions.jsonl',runtime)
        self.assertIn('director_player.json',learning)
        self.assertIn('director_playbook.json',learning)
